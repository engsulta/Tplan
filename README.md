...
and notes. The application  remind the user with his trips on the time specified
by the user. In addition, the application  navigate the user to his destination. After that, the application  keep track with the upcoming and past trips.
Features :
